...
"use strict";
/* DOT (.) FOR ID AND HASH (#) FOR CLASS */

/* BOTH FUNCTIONS ARE FINE TO USE - GETELEMENTBYID LITTLE FASTER */
// Selecting elements
...
var btnHold = document.querySelector(".btn--hold"); // Define variables
...
var init = function init() {
  ...
  player0El.classList.add("player--active"); // Player 1 is active at start
...
btnHold.addEventListener("click", function () {
  if (playing) {
    ...
    document.getElementById("score--".concat(activePlayer)).textContent = scores[activePlayer]; // 2. Check if players score is >= 100
